...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFEBD391);
  late Color secondary = const Color(0xFF8C9168);
  late Color tertiary = const Color(0xFF655245);
  late Color alternate = const Color(0xFF484848);
  late Color primaryText = const Color(0xFF343533);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFDAD3D3);
  late Color secondaryBackground = const Color(0xFFB9B9B9);
