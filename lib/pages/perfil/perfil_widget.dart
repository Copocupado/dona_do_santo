...
import '../../backend/schema/relatorio_reverse_credits_record.dart';
...
class PerfilWidgetState extends State<PerfilWidget> {
  ...
  static final ValueNotifier<bool?> isNotificationsEnabled =
      ValueNotifier(null);
  ...
  Future<void> checkIfNotificationsEnabled() async {
    ...
    try {
      ...
      isNotificationsEnabled.value =
          doc.data()!['user_reference'] == currentUserReference;
    } catch (e) {
          ...
          children: [
            Text(
              ...
              style: FlutterFlowTheme.of(context).bodyMedium.override(
                    fontFamily: 'Readex Pro',
                    fontSize: 50,
                    color: currentUserDocument!.reverseCredits < 0 ? FlutterFlowTheme.of(context).error :  FlutterFlowTheme.of(context).primaryText,
                  ),
            ),
            InkWell(
                        ...
                        child: SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'Veja suas movimentações dos seus créditos.',
                                ...
                                StreamBuilder<List<RelatorioReverseCreditsRecord>>(
                                  stream: FFAppState().relatorios(
                                    uniqueQueryKey: currentUserReference!.id,
                                    requestFn: () => queryRelatorioReverseCreditsRecord(
                                      parentDocRef: currentUserReference!,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    List<RelatorioReverseCreditsRecord> items = snapshot.data!;
                                    return snapshot.data!.isNotEmpty ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        final bool valueIsNegative = items[index].valueChanged < 0;
                                        final bool valueChangedByFunc = items[index].information.startsWith('Valor');
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Align(
                                                alignment: const AlignmentDirectional(0, 0),
                                                child: FaIcon(
                                                  valueChangedByFunc ? FontAwesomeIcons.dollarSign : FontAwesomeIcons.handHoldingDollar,
                                                  color: FlutterFlowTheme.of(context).primaryText,
                                                  size: 24,
                                                ),
                                              ),
                                            ...
                                            Text(
                                              'R\$${convertDoubleToString(items[index].valueChanged)}',
                                              style: FlutterFlowTheme.of(context).bodyLarge.override(
                                                fontFamily: 'Readex Pro',
                                                letterSpacing: 0.0,
                                                color: valueIsNegative ? FlutterFlowTheme.of(context).error : FlutterFlowTheme.of(context).success,
                                              ),
                                            ),
                                          ].divide(const SizedBox(width: 8)),
                                        );
                                      },
                                    ) : const components.DataNotFound(title: 'Nada encontrado! Começe comprando ou vendendo na aba Reverse');
                                  },
                                ),
                        ...
                        child: Column(
                          ...
                          children:[
                            ClipRRect(
                              ...
                              child: Stack(
                                children: [
                                  components.ApplyBackGroundStyles(
                                    imagePath: 'assets/images/reverse_credits/background-image.webp',
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Align(
                                              alignment: const AlignmentDirectional(0, 1),
                                              child: AutoSizeText(
                                                'Créditos que podem ser trocados por produtos em qualquer uma de nossas lojas.',
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                  fontFamily: 'Readex Pro',
                                          ...
                                          SizedBox(
                                            child: Align(
                                              alignment: const AlignmentDirectional(0, 1),
                                              child: AutoSizeText(
                                                'Receba ou gaste seus créditos nos seguintes setores: ',
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              AutoSizeText(
                                                '* Vender na nossa plataforma reverse.',
                                                textAlign: TextAlign.left,
                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                  fontFamily: 'Readex Pro',
                                                  color: FlutterFlowTheme.of(context).primaryBackground,
                                              ...
                                              AutoSizeText(
                                                '* Comprar em nossas lojas físicas.',
                                                textAlign: TextAlign.left,
                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                  fontFamily: 'Readex Pro',
                                                  color: FlutterFlowTheme.of(context).primaryBackground,
                                              ...
                                              AutoSizeText(
                                                '* Conversar com um de nossos funcionários para a correção de valores.',
                                                textAlign: TextAlign.left,
                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                  fontFamily: 'Readex Pro',
                                                  color: FlutterFlowTheme.of(context).primaryBackground,
                        ...
                        return Switch.adaptive(
                          ...
                          onChanged: (newValue) async {
                            ...
                            await Future.delayed(const Duration(
                                milliseconds: 3000)); //evita spam
                            isUpdating.value = false;
                            await Future.delayed(const Duration(
                                milliseconds:
                                    100)); //mantem a animacao do switch
...
class DeleteAccountConfirmationDialogState extends State<DeleteAccountConfirmationDialog> {
